...
export class NotificationService {
  ...
  /**
   * Convenience method for sending email verification
   */
  ...
  /**
   * Convenience method for sending user creation notification
   */
  async sendUserCreationNotification(
    ...
    return this.sendNotification({
      type: NotificationType.EMAIL,
      template: NotificationTemplate.USER_CREATION,
      recipient: email,
      content: {
        name,
        email,
  ...
  /**
   * Convenience method for sending tour creation notification
   */
  async sendTourCreationNotification(
    ...
    const tourUrl = `${this.configService.get('APP_URL')}/tours/${tourId}`;

    return this.sendNotification({
      type: NotificationType.EMAIL,
      template: NotificationTemplate.TOUR_CREATION,
      recipient: email,
      content: {
        name,
        tourName,
  ...
  /**
   * Convenience method for sending password reset notification
   */
  ...
  /**
   * Convenience method for sending booking confirmation
   */
  async sendBookingConfirmationNotification(
    ...
    const bookingUrl = `${this.configService.get('APP_URL')}/bookings/${bookingId}`;
